...
function printKeysAndValues(obj) {
  ...
  for (const cou in country) {
    console.log(`key: ${cou} value: ${cou.obj}`);
    // не знаю як зробити value :(
  }
}
...
function addProperty(array) {
  ...
  Array.customProperty = "My property";
...
const newArr.customProperty = [1, 2, 3, 4, 5];
